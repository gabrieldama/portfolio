...
<p align="center">
  ...
  Tema visual inspirado em <em>Undertale</em>, usando as fontes oficiais do jogo.
</p>
...
└── fonts/            # Fontes Undertale (woff)
    ├── DeterminationMonoWeb.woff
    ├── DeterminationSansWeb.woff
    ├── MonsterFriendBack.woff
    ├── MonsterFriendFore.woff
    ├── MERCY.woff
    └── MNC.woff
```
